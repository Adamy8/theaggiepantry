...
export const productData: Product[] = [
  {
    ...
    tags: ['vegetables', 'fresh', 'available'],
  ...
  },
  {
    ...
    tags: ['non-perishable', 'available', 'beans'],
    dietary: ['vegan', 'gluten-free'],
    type: 'safeway',
    source: 'Donation',
    isAvailable: true,
  ...
  },
  {
    ...
    tags: ['dairy', 'refrigerated', 'available'],
    dietary: [],
    type: 'safeway',
    source: 'Sysco',
    isAvailable: true,
  ...
  },
  {
    ...
    quantity: 25,
    dateAdded: '2023-04-10',
    tags: ['non-perishable', 'available', 'soup'],
    dietary: [],
    type: 'safeway',
    source: 'Donation',
    isAvailable: true,
  ...
  },
  {
    ...
    tags: ['non-perishable', 'available', 'vegetables'],
    dietary: ['vegan', 'gluten-free'],
    type: 'safeway',
    source: 'Sysco',
    isAvailable: true,
  ...
  },
  {
    ...
    tags: ['pastries', 'available', 'snacks'],
    dietary: ['vegetarian'],
    type: 'local',
    source: 'Local Bakery',
    isAvailable: true,
  ...
  },
  {
    ...
    tags: ['refrigerated', 'available', 'snacks'],
    dietary: ['vegan', 'gluten-free'],
    type: 'local',
    source: 'Community Donation',
    isAvailable: true,
